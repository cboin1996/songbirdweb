...
export default function SongPickerModal({
    ...
    const body = (
        <div data-testid={testId} className="fixed inset-x-0 top-0 bottom-[var(--player-bar-h,88px)] sm:inset-0 z-[80] flex items-end sm:items-center justify-center">
            ...
            <div className="relative z-10 w-full sm:w-[480px] max-h-[85svh] sm:max-h-[85vh] flex flex-col bg-surface rounded-t-2xl sm:rounded-2xl shadow-2xl overflow-hidden">
                {/* header */}
